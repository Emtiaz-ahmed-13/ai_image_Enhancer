...
function App() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-gray-900 text-white px-6 py-8 animate-gradient">
      <div className="text-center mb-12 space-y-4">
        ...
        <p className="text-gray-300 mt-2 text-lg transition-transform hover:scale-105">
          Powered By <span className="text-purple-300 font-semibold hover:text-purple-200 cursor-pointer">©Emtiaz</span>
        </p>
      </div>
      ...
      <footer className="mt-12 text-gray-400 text-center text-sm space-y-2">
